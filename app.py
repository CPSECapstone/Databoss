...
def sqlite_setup():
    ...
    cap.add("Capture1", datetime(2018, 2, 5, 1, 1, 1), datetime(2018, 2, 5, 1, 1, 1), "myRDS1", 1, 1, "interactive")
    ...
    cap.add("Capture2", datetime(2018, 2, 5, 1, 1, 1), datetime(2018, 2, 5, 1, 1, 1), "myRDS4", 2, 2, "interactive")
